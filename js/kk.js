...
var sHeight=document.documentElement.scrollHeight;		//获取页面的高的长度-->
	...
	<form action=\"#\" method=\"post\" name=\"biaobai\">\
	<input name=\"dfname\" type=\"text\" value=\"表白对象名称\" maxlength=\"20\" onClick=\"this.value=''\" txt=><br><br><br><br>\
	<input name=\"dfemall\" type=\"text\" value=\"对方邮箱，系统自动邮箱通知(可不填)\" maxlength=\"20\" onClick=\"this.value=''\"><br><br><br><br>\
	<input name=\"name\" type=\"text\" value=\"自己的名称\" maxlength=\"20\" onClick=\"this.value=''\"><br><br><br><br>\
	<input name=\"qq\" type=\"text\" value=\"自己QQ号,自动获取头像（匿名可不填）\" maxlength=\"30\" onClick=\"this.value=''\"><br><br><br><br>\
	<textarea onFocus=\"if(value==defaultValue){value='';}\" onBlur=\"if(!value){value=defaultValue;}\">你想说的话</textarea>\
